...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    try {
        ...
        validateForm() {
            ...
            // Validación específica para descripcion
            const descripcion = document.getElementById('descripcion');
            if (descripcion.value && (descripcion.value < 0 || descripcion.value > 100)) {
                this.showFieldError('descripcion', 'La descripcion debe estar entre 0 y 100 años');
                isValid = false;
            }
